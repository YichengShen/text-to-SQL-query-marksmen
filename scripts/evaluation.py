# Code adapted from repo of Spider Dataset (https://github.com/taoyds/spider)
...
def evaluate(gold, predict, db_dir, etype, kmaps, verbose=False):
    with open(gold) as f:
...
if __name__ == "__main__":
    ...
    assert verbose in ["True", "False"], "Verbose can only be True or False"
    ...
    evaluate(gold, pred, db_dir, etype, kmaps, verbose)
